...
do
    echo 'sh /path/to/your/S01.scRNA_UMI_QC.sh' $i > $i/S01.work.sh && \
    echo 'sh /path/to/your/S02.scRNA_UMI_STAR.sh' $i > $i/S02.work.sh && \
    echo 'sh /path/to/your/S03.scRNA_UMI_UMI.sh' $i > $i/S03.work.sh
